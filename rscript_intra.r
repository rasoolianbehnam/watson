...
mit_file_name <- sprintf("../data/data/chr%02d_chr%02d_mit.edges", chr1, chr2)
all_file_name <- sprintf("../data/data/chr%02d_chr%02d_all.edges", chr1, chr2)
rl_file_name <- sprintf("../data/data/chr%02d_chr%02d_rl.edges", chr1, chr2)
call4_file_name <- sprintf("../data/data/chr%02d_chr%02d_call4.edges", chr1, chr2)
...
mit_graphlet_file = sprintf("../data/data/chr%02d_chr%02d_mit.graphlets", chr1, chr2)
all_graphlet_file = sprintf("../data/data/chr%02d_chr%02d_all.graphlets", chr1, chr2)
rl_graphlet_file = sprintf("../data/data/chr%02d_chr%02d_rl.graphlets", chr1, chr2)
call4_graphlet_file = sprintf("../data/data/chr%02d_chr%02d_call4.graphlets", chr1, chr2)
