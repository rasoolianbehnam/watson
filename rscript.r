...
write.csv2(mit_graphlets, file = mit_graphlet_file ,row.names=FALSE)
write.csv2(all_graphlets, file = all_graphlet_file ,row.names=FALSE)
write.csv2(rl_graphlets, file = rl_graphlet_file ,row.names=FALSE)
write.csv2(call4_graphlets, file = call4_graphlet_file ,row.names=FALSE)
