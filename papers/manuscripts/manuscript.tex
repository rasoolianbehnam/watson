...
\begin{table}[]
    ...
    \resizebox{.5\textwidth}{!}{
        \begin{tabular}{lllllp{1cm}ll}
            &\multicolumn{1}{c}{\textbf{\huge Cell A graphlets $S^A_{i,j}$}}  & \multicolumn{1}{c}{\textbf{\huge Cell B graphlets $S^B_{i,j}$}} 
            && \multicolumn{1}{c}{\textbf{\huge Correlation Vector $m^{A,B}_{i,j}$}} 
            && \multicolumn{1}{c}{\textbf{\huge Correlation Matrix $M^{A,B}_{i,j}$}} \vspace{.5cm} \\
        &\multicolumn{1}{c}{$N_1$}  & \multicolumn{1}{c}{72} && \multicolumn{1}{c}{72} \vspace{.5cm}\\
        \rule{0pt}{40pt}
        $N_1$ &
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            C^A_{\scriptscriptstyle 1,1,1,1}     &   C^A_{\scriptscriptstyle 1,1,1,1}  & \cdots    &    C^A_{\scriptscriptstyle 1,1,1,N_1} \\
            C^A_{\scriptscriptstyle 1,1,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
            C^A_{\scriptscriptstyle 1,1,N_1,1}   &                &                  &    C^A_{\scriptscriptstyle 1,1,N_1, N_1} 
        \end{pmatrix}$} &
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            C^B_{\scriptscriptstyle 1,1,1,1}     &   C^B_{\scriptscriptstyle 1,1,1,1}  & \cdots    &    C^B_{\scriptscriptstyle 1,1,1,N_1} \\
            C^B_{\scriptscriptstyle 1,1,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
            C^B_{\scriptscriptstyle 1,1,N_1,1}   &                &                  &    C^B_{\scriptscriptstyle 1,1,N_1, N_1} 
        \end{pmatrix}$} &
        \begin{tikzpicture}
            \draw [->] (0, 0) -> (2, 0);
        \end{tikzpicture} &
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            m_{\scriptscriptstyle 1,1,0}     &   m_{\scriptscriptstyle 1,1,1}  & \cdots    &    m_{\scriptscriptstyle 1,1,72}
        \end{pmatrix}$} \vspace{1cm}\\


        &\multicolumn{1}{c}{$N_2$}  & \multicolumn{1}{c}{72} && \multicolumn{1}{c}{72} \vspace{.5cm}\\
        \rule{0pt}{45pt}
        $N_1$ &
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            C^A_{\scriptscriptstyle 1,2,1,1}     &   C^A_{\scriptscriptstyle 1,2,1,1}  & \cdots    &    C^A_{\scriptscriptstyle 1,2,1,N_1} \\
            C^A_{\scriptscriptstyle 1,2,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
            C^A_{\scriptscriptstyle 1,2,N_1,1}   &                &                  &    C^A_{\scriptscriptstyle 1,2,N_1, N_1} 
        \end{pmatrix}$}&
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            C^B_{\scriptscriptstyle 1,2,1,1}     &   C^B_{\scriptscriptstyle 1,2,1,1}  & \cdots    &    C^B_{\scriptscriptstyle 1,2,1,N_2} \\
            C^B_{\scriptscriptstyle 1,2,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
            C^B_{\scriptscriptstyle 1,2,N_2,1}   &                &                  &    C^B_{\scriptscriptstyle 1,2,N_1, N_2} 
        \end{pmatrix}$}&
        \begin{tikzpicture}
            \draw [->] (0, 0) -> (2, 0);
        \end{tikzpicture} &
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            m_{\scriptscriptstyle 1,2,0}     &   m_{\scriptscriptstyle 1,2,1}  & \cdots    &    m_{\scriptscriptstyle 1,2,72}
        \end{pmatrix}$} \vspace{1cm}\\
        ...
        $\begin{pmatrix}  
            ...
            m_{\scriptscriptstyle 1,2,0}     &   m_{\scriptscriptstyle 1,2,1}  & \cdots    &    m_{\scriptscriptstyle 1,2,72} \\ 
            \vdots & \vdots & \vdots \\
            m_{\scriptscriptstyle 22,23,0}     &   m_{\scriptscriptstyle 22,23,1}  & \cdots    &    m_{\scriptscriptstyle 22,23,72} \\ 
            m_{\scriptscriptstyle 22,23,0}     &   m_{\scriptscriptstyle 22,23,1}  & \cdots    &    m_{\scriptscriptstyle 22,23,72}
        \end{pmatrix}$} \vspace{1cm}\\
        
        &\multicolumn{1}{c}{\Large o}  & \multicolumn{1}{c}{\Large o} && \multicolumn{1}{c}{\Large o} \vspace{1cm}\\

        &\multicolumn{1}{c}{$N_{23}$}  & \multicolumn{1}{c}{72} && \multicolumn{1}{c}{72} \vspace{.5cm}\\
        \rule{0pt}{45pt}
        $N_{22}$ &
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            C^A_{\scriptscriptstyle 22,23,1,1}     &   C^A_{\scriptscriptstyle 22,23,1,1}  & \cdots    &    C^A_{\scriptscriptstyle 22,23,1,N_1} \\
            C^A_{\scriptscriptstyle 22,23,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
            C^A_{\scriptscriptstyle 22,23,N_1,1}   &                &                  &    C^A_{\scriptscriptstyle 22,23,N_1, N_1} 
        \end{pmatrix}$}&
        \resizebox{\linewidth}{!}{%
        $\begin{pmatrix}  
            C^B_{\scriptscriptstyle 22,23,1,1}     &   C^B_{\scriptscriptstyle 22,23,1,1}  & \cdots    &    C^B_{\scriptscriptstyle 22,23,1,N_2} \\
            C^B_{\scriptscriptstyle 22,23,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
            C^B_{\scriptscriptstyle 22,23,N_2,1}   &                &                  &    C^B_{\scriptscriptstyle 22,23,N_1, N_2} 
        \end{pmatrix}$}&
        \begin{tikzpicture}
            \draw [->] (0, 0) -> (2, 0);
        \end{tikzpicture} &
...
\begin{tikzpicture}
    ...
    \node [] (h11) [left=1pt of a1] {$N_1$};
    \node [] (w11) [above=1pt of a1] {$N_1$};
    ...
    \node [] (h12) [left=1pt of b1] {$N_1$};
    \node [] (w12) [above=1pt of b1] {$73$};
    ...
    \node [] (h21) [left=1pt of a2] {$N_1$};
    \node [] (w21) [above=1pt of a2] {$N_2$};
    ...
    \node [] (h22) [left=-.2cm of b2] {$\scriptstyle N_1 + N_2$};
    \node [] (w22) [above=1pt of b2] {$73$};
    ...
    \node [] (w3) [above=1pt of b2] {$73$};
    \draw [->] (b1.east) to (c1.west);

    \node [] (transition) [below=1cm of a2] {};
    
    %Second Row
    %first
    \node [] (a3) [below=1cm of transition] {
        $\begin{pmatrix}  
            C^A_{\scriptscriptstyle 22,23,1,1}     &   C^A_{\scriptscriptstyle 22,23,1,1}  & \cdots    &    C^A_{\scriptscriptstyle 22,23,1,N_1} \\
            C^A_{\scriptscriptstyle 22,23,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
    ...
    \node [] (h31) [left=1pt of a3] {$N_1$};
    \node [] (w31) [above=1pt of a3] {$N_2$};

    \node [] (transition) [] {};

    %second
    \node [] (b3) [right = 1cm of a3] {
        $\begin{pmatrix}  
            C^B_{\scriptscriptstyle 22,23,1,1}     &   C^B_{\scriptscriptstyle 22,23,1,1}  & \cdots    &    C^B_{\scriptscriptstyle 22,23,1,N_2} \\
            C^B_{\scriptscriptstyle 22,23,2,1}     &                &                  &      \\
            \vdots                             &                & \ddots           &      \\
    ...
    \node [] (h32) [left=-.2cm of b3] {$\scriptstyle N_1 + N_2$};
    \node [] (w32) [above=1pt of b3] {$73$};

    %third
    \node [] (c3) [right = 1cm of b3] {
        $\begin{pmatrix}  
            m_{\scriptscriptstyle 22,23,0}     &   m_{\scriptscriptstyle 22,23,1}  & \cdots    &    m_{\scriptscriptstyle 22,23,72}
        \end{pmatrix}$
    };
    \node [] (w3) [above=1pt of b3] {$73$};
    \draw [->] (b1.east) to (c1.west);
