...
%    \node [] (a) at (0, 0) {
%        $\begin{pmatrix}  
%            C_{\scriptscriptstyle 1,1,1,1}     &   C_{\scriptscriptstyle 1,1,1,1}  & \cdots    &    C_{\scriptscriptstyle 1,1,1,N_1} \\
%            C_{\scriptscriptstyle 1,1,2,1}     &                &                  &      \\
%            \vdots                             &                & \ddots           &      \\
%            C_{\scriptscriptstyle 1,1,N_1,1}   &                &                  &    C_{\scriptscriptstyle 1,1,N_1, N_1} 
%        \end{pmatrix}$
%    };
%    \node [] (b) [left=1pt of a] {$N_1$};
%    \node [] (c) [above=1pt of a] {$N_1$};
%\end{tikzpicture}
\bibliography{lit}
